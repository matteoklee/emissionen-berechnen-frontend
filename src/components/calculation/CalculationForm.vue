          ...
          <form @submit.prevent="onSubmit">
            ...
            <div class="flex flex-col gap-4 mt-4 mx-4">
              <template v-if="stepIndex === 1">
                <div class="max-w-screen-lg mx-auto my-4">Step1</div>
              </template>

              <template v-if="stepIndex === 2">
                <div class="max-w-screen-lg mx-auto my-4">Step2</div>
              </template>

              <template v-if="stepIndex === 3">
                <div class="max-w-screen-lg mx-auto my-4">Step3</div>
              </template>
            </div>

            <div class="flex items-center justify-between mt-4 max-w-screen-lg lg:mx-auto mx-8">
              <Button variant="outline" type="button" size="sm" @click="prevStep()"> Back </Button>
