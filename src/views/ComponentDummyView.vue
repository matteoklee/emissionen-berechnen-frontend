<template>
  ...
  <div class="max-w-screen-xl mx-auto">
    ...
    />
    <div
        class="relative overflow-hidden justify-center items-center mx-20"
    >
      <!-- First Marquee -->
      <Marquee
          pause-on-hover
    ...
    <div class="flex min-h-64 items-center justify-center">
      <p
          className="whitespace-pre-wrap text-6xl text-black dark:text-white"
      >
...
export default {
  name: "CalculatorView",
  components: {SafariMockup, TextHoverEffect, NumberTicker, Marquee, AnimatedLogoCloud, LandingHero},
  data() {
    return {
      logos: [
        {
